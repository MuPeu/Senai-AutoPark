...
<html>
    <head>
        ...
        <link rel="icon" href="./src/img/Icon-tab.svg">
        <link rel="stylesheet" href="./src/styles/style-preco.css">
    </head>
    <body>
        <%
        ...
        <div class="precos-title-container">
            <img src="./src/img/Logo-Senai-AutoPark.svg" alt="Logo - Senai AutoPark">
        ...
        <form method="post" action="alterar_preco.jsp">
            ...
            <fieldset class="precos-form">
                <div class="input-box">
                    <img src="./src/img/Dollar sign.svg" alt="">
