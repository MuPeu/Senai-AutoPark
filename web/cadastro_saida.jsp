...
<html>
    <head>
        ...
        <link rel="stylesheet" href="./src/styles/style-saida.css"> 
    </head>
    <body>
                ...
                <div class="preco-box">
                    ...
                    <div class="date-box">
                       <div class="date-card">
                            ...
                            <img src="./src/img/solar_calendar-line-duotone.svg" alt="">
                       </div> 
                       ...
                       <div class="date-card">
                            ...
                            <img src="./src/img/material-symbols-light_departure-board-outline.svg" alt="">
                        </div>  
                   </div>                    
                </div>
